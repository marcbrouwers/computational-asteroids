...
save_obj(xast, "xast" + '_' + str(t_end/1000))
save_obj(vsun, "vsun" + '_' + str(t_end/1000))
save_obj(vjup, "vjup" + '_' + str(t_end/1000))
save_obj(vast, "vast" + '_' + str(t_end/1000))
